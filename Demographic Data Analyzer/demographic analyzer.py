...
def calculate_demographic_data(print_data=True):
    ...
    rich_people = df[(df['hours-per-week'] == min_work_hours) & (df['salary'] == '>50K')]

    rich_percentage = round(len(rich_people) / len(num_min_workers) * 100, 1)
    ...
    occupation_india = people_india['occupation'].value_counts()
